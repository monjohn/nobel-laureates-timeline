...
var connect__delegate = function (url,p__10936){
var vec__10938 = p__10936;
var opts = cljs.core.nth.call(null,vec__10938,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__10938,opts){
return (function (evt){
...
});})(conn,vec__10938,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__10938,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__10938,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__10938,opts){
return (function (evt){
...
var G__10939__i = 0, G__10939__a = new Array(arguments.length -  1);
while (G__10939__i < G__10939__a.length) {G__10939__a[G__10939__i] = arguments[G__10939__i + 1]; ++G__10939__i;}
  p__10936 = new cljs.core.IndexedSeq(G__10939__a,0);
} 
return connect__delegate.call(this,url,p__10936);};
connect.cljs$lang$maxFixedArity = 1;
connect.cljs$lang$applyTo = (function (arglist__10940){
var url = cljs.core.first(arglist__10940);
var p__10936 = cljs.core.rest(arglist__10940);
return connect__delegate(url,p__10936);
});
