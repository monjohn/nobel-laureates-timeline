...
var vec__20920 = ((cljs.core.map_QMARK_.call(null,credentials))?cljs.core.map.call(null,credentials,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"username","username",1605666410),new cljs.core.Keyword(null,"password","password",417022471)], null)):credentials);
var username = cljs.core.nth.call(null,vec__20920,(0),null);
var password = cljs.core.nth.call(null,vec__20920,(1),null);
...
*/
cljs_http.util.build_url = (function build_url(p__20921){
var map__20924 = p__20921;
...
var query_string = cljs.core.get.call(null,map__20924__$1,new cljs.core.Keyword(null,"query-string","query-string",-1018845061));
var uri = cljs.core.get.call(null,map__20924__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
var server_port = cljs.core.get.call(null,map__20924__$1,new cljs.core.Keyword(null,"server-port","server-port",663745648));
var server_name = cljs.core.get.call(null,map__20924__$1,new cljs.core.Keyword(null,"server-name","server-name",-1012104295));
var scheme = cljs.core.get.call(null,map__20924__$1,new cljs.core.Keyword(null,"scheme","scheme",90199613));
return [cljs.core.str((function (){var G__20925 = (new goog.Uri());
G__20925.setScheme(cljs.core.name.call(null,(function (){var or__3735__auto__ = scheme;
...
G__20925.setDomain(server_name);

G__20925.setPort(server_port);

G__20925.setPath(uri);

G__20925.setQuery(query_string,true);
...
return cljs.core.reduce.call(null,(function (p1__20927_SHARP_,p2__20926_SHARP_){
var vec__20929 = clojure.string.split.call(null,p2__20926_SHARP_,/:\s+/);
var k = cljs.core.nth.call(null,vec__20929,(0),null);
var v = cljs.core.nth.call(null,vec__20929,(1),null);
if(cljs.core.truth_((function (){var or__3735__auto__ = clojure.string.blank_QMARK_.call(null,k);
if(cljs.core.truth_(or__3735__auto__)){
return or__3735__auto__;
} else {
...
return p1__20927_SHARP_;
} else {
return cljs.core.assoc.call(null,p1__20927_SHARP_,clojure.string.lower_case.call(null,k),v);
}
}),cljs.core.PersistentArrayMap.EMPTY,clojure.string.split.call(null,(function (){var or__3735__auto__ = headers;
if(cljs.core.truth_(or__3735__auto__)){
return or__3735__auto__;
} else {
return "";
