...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4322__auto__,writer__4323__auto__,opt__4324__auto__){
return cljs.core._write(writer__4323__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var i_25956 = (0);
while(true){
if((i_25956 < arr.length)){
(arr[i_25956] = null);

var G__25957 = (i_25956 + (1));
i_25956 = G__25957;
continue;
} else {
}
...
var i_25969 = (self__.level + (1));
while(true){
if((i_25969 <= (new_level + (1)))){
(update[i_25969] = self__.header);

var G__25970 = (i_25969 + (1));
i_25969 = G__25970;
continue;
} else {
}
...
var i_25971 = (0);
while(true){
if((i_25971 <= self__.level)){
var links_25972 = (update[i_25971]).forward;
if(((links_25972[i_25971]) === x__$1)){
(links_25972[i_25971] = (x__$1.forward[i_25971]));

var G__25973 = (i_25971 + (1));
i_25971 = G__25973;
continue;
} else {
var G__25974 = (i_25971 + (1));
i_25971 = G__25974;
continue;
}
} else {
...
if(!((nx == null))){
var G__25976 = nx;
var G__25977 = (level__$1 - (1));
x = G__25976;
level__$1 = G__25977;
continue;
} else {
var G__25978 = x;
var G__25979 = (level__$1 - (1));
x = G__25978;
level__$1 = G__25979;
continue;
}
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4322__auto__,writer__4323__auto__,opt__4324__auto__){
return cljs.core._write(writer__4323__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
var or__3735__auto__ = (cljs.core.truth_((function (){var and__3723__auto__ = me;
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__3735__auto__,timeout__$1,me){
return (function (){
cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);

return cljs.core.async.impl.protocols.close_BANG_(timeout_channel);
});})(timeout_channel,or__3735__auto__,timeout__$1,me))
,msecs);
